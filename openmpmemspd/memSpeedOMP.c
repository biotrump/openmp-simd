/*
gcc memSpeedOMP.c cpuidc.c -lrt -lc -lm -O3 -mcpu=cortex-a7 -mfloat-abi=hard -mfpu=neon-vfpv4 -funsafe-math-optimizations -fopenmp -o OpenMP-MemSpeed

Affinity Setting
taskset 0x00000001 ./OpenMP-MemSpeed
...
//  #define version  "64 Bit Version 4"
  #define version  "OpenMP Version 1"
